...
- (void)postObject:(id)object toResource:(NSString *)resource options:(id)options encoding:(AWFParameterEncoding)encoding completion:(AWFApiEndpointCompletionBlock)completionBlock;
...
- (void)putObject:(id)object toResource:(NSString *)resource options:(id)options encoding:(AWFParameterEncoding)encoding completion:(AWFApiEndpointCompletionBlock)completionBlock;
